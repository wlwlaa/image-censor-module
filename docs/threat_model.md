...
| File replacement after approval | Download checks SHA-256, passport HMAC, and artifact ID binding | Use immutable object versions |
...
| IDOR on download | Demo bearer token is required | Add per-user and tenant-bound authorization |
